...
public final class BasicData {
	...
	public BasicData(String colloq, boolean consumeOnFull, boolean consumed,
			int depth, String description, List<String> from, Gold gold,
			String group, boolean hideFromAll, int id, Image image,
			boolean inStore, List<String> into, Map<String, Boolean> maps,
			String name, String plaintext, String requiredChampion,
			MetaData rune, String sanitizedDescription, int specialRecipe,
			int stacks, BasicDataStats stats, List<String> tags) {
		this.colloq = colloq;
